...
#include "GameAnalytics/Public/EGAAdError.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEGAAdError() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_GameAnalytics_EGAAdError_Hash() { return 1183116980U; }
	UEnum* Z_Construct_UEnum_GameAnalytics_EGAAdError()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/EGAAdError.h" },
